...
module.exports = {
    ...
    changeVanity(token, vanity, guildId) {
    ...
    muteMember(member, mutedRole, reason) {
        member.client.managers.mutesManager.getAndCreateIfNotExists(`${member.guild.id}-${member.id}`, {
