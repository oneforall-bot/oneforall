module.exports = {
    ...
    run: async(oneforall, interaction, memberData, guildData) => {
        ...
        const members = interaction.guild.members.cache.filter(m => !m.bot && m.voice.channelId);
        ...
        await interaction.reply({content: lang.vc.msg(count, muteCount, streamingCount, muteHeadSetCount, openMicCount)})
    }
}
